...
Hoe.new('ruby-hmac', HMAC::VERSION) do |p|
  p.name = "ruby-hmac"
  p.author = ["Daiki Ueno", "Geoffrey Grosenbach", 'Marius Mathiesen']
  p.email = 'marius.mathiesen@gmail.com'
  p.summary = "A forward port of the ruby-hmac gem. Ruby 1.9 only"
...
task :verify => :package do
  ...
  if system %(ruby19 -e "require 'pkg/ruby-hmac-#{HMAC::VERSION}/lib/hmac'")
